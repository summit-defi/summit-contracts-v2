...
export const getBifiVault = async () => await getContract(Contracts.DummyVault)
export const getBifiVaultPassthrough = async () => await getContract(Contracts.BeefyVaultV6Passthrough)
